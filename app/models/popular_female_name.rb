class PopularFemaleName < ApplicationRecord
  after_validation :set_name_title

  validates :name_id, presence: true, uniqueness: true

  validate :exclusively_female_names_and_name_must_exist, on: :create
  ...
  def exclusively_female_names_and_name_must_exist
    errors.add(:base, "Must be exclusively Female names") unless name.female?
